				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.jsp" class="logo"><strong>Centro de estudios Montreal </strong> Familias anfitrionas</a>
									<ul class="icons">
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										<header>
											<h1>Subir la documentacion</h1>
										</header>
									</div>
								</section>

							<!-- Section -->
							<h4>Para terminar la postulacion se debe subir los siguientes documentos</h4>
